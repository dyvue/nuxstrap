        ...
        <div class="collapse navbar-collapse justify-content-between">
          ...
          <ul class="navbar-nav header-right">
            <li class="nav-item dropdown notification_dropdown">
              <a class="nav-link dz-fullscreen primary" href="javascript:void(0)" @click="toggleFullscreen">
            ...
            <li class="nav-item dropdown header-profile">
              <a class="nav-link" href="javacsript:void(0)" role="button" data-toggle="dropdown">
                <div class="header-info">
                  <span>Hi, <strong>Romadhan Prasetyo</strong></span>
                </div>
                <img src="@/assets/images/avatar/user.png" width="20" alt="" />
              </a>
              <div class="dropdown-menu dropdown-menu-right">
                <nuxt-link to="/" class="dropdown-item ai-icon">
